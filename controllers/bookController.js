...
exports.book_detail = asyncHandler(async (req, res, next) => {
  // Get details of books, book instaces for specific book
...
exports.book_create_post = [
  ...
  body("author", "Author must be not empty")
    .trim()
    .isLength({ min: 1 })
    .escape(),
  body("summary", "Summary must be not empty")
    .trim()
    .isLength({ min: 1 })
    .escape(),
  ...
  asyncHandler(async (req, res, next) => {
    ...
    // Create book object with escaped and trimed data
    const book = new Book({
