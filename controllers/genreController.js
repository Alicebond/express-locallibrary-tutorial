...
exports.genre_create_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    // Create a new genre object with new escaped and trimed data
    ...
    if (!errors.isEmpty()) {
      ...
      const genreExists = new Genre.findOne({ name: req.body.name }).exec();
      if (genreExists) {
...
exports.genre_delete_get = asyncHandler(async (req, res, next) => {
  // Get genre details and all their books in parallel
